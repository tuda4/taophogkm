  ...
  return (
    ...
    >
      <motion.div
        ...
        onViewportEnter={() => setSelectPage(SelectPage.AboutUs)}
      >
      ...
      <div className=" relative">
        <div className="z-10 lg:mt-10 ">
          ...
          >
            <div className="relative">
              ...
              <p className="my-3 text-md text-[#292048]  text-">
        ...
        <div
          className="pt-4 mx-auto w-5/6 flex justify-center lg:z-10 lg:max-w-[1024px]
            "
        >
